...
#define GENERICAPP_END_NO             '2'   // 终端节点编号
//#define GENERICAPP_END_MAX_NUM        3   // 终端节点编号
...
#define GENERICAPP_RAIN_CLUSTERID     2     //发送雨量命令事件ID

// Send Message Timeout
#define GENERICAPP_SEND_MSG_TIMEOUT   500   // 消息时延
